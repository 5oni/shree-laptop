...
export const metadata: Metadata = {
  title: 'Laptop Shop in Rawatsar | Buy Used & Refurbished Laptops | Shree Laptop Solutions',
  description: 'Best laptop shop in Rawatsar, Hanumangarh district. Quality used & refurbished laptops, gaming laptops, and accessories at affordable prices. Free delivery in Rawatsar and nearby areas.',
  keywords: 'laptop shop in Rawatsar, buy laptop Rawatsar, used laptop Rawatsar, refurbished laptop Rawatsar, gaming laptop Rawatsar, laptop accessories Rawatsar, Rawatsar laptop dealer',
  openGraph: {
    title: 'Laptop Shop in Rawatsar | Shree Laptop Solutions',
    description: 'Best laptop shop in Rawatsar, Hanumangarh district. Quality used & refurbished laptops at affordable prices.',
    url: 'https://shreelaptop.shop/seo/rawatsar-laptops',
    siteName: 'Shree Laptop Solutions',
    locale: 'en_IN',
    type: 'website',
  },
  alternates: {
    canonical: 'https://shreelaptop.shop/seo/rawatsar-laptops',
  },
};

export default function RawatsarLaptopsPage() {
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800 dark:text-white">
            Best Laptop Shop in <span className="text-primary-600">Rawatsar</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-8">
            Get quality used and refurbished laptops delivered to Rawatsar from our Hanumangarh shop. 
            We offer gaming laptops, budget laptops, and accessories with free delivery across Rawatsar tehsil.
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-500 dark:text-gray-400">
            <span className="bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">✓ Free Delivery to Rawatsar</span>
        ...
        {/* Why Choose Us for Rawatsar */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800 dark:text-white">
            Why Rawatsar Customers Choose Shree Laptop Solutions
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800 dark:text-white">Free Delivery to Rawatsar</h3>
              <p className="text-gray-600 dark:text-gray-300">
                We deliver laptops directly to your doorstep in Rawatsar with no extra charges.
              </p>
            </div>
        ...
        {/* Popular Laptop Categories for Rawatsar */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800 dark:text-white">
            Popular Laptop Categories in Rawatsar
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 p-6 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">High-performance gaming laptops for students and professionals in Rawatsar</p>
            ...
            <div className="bg-gradient-to-br from-accent-50 to-accent-100 dark:from-accent-900/20 dark:to-accent-800/20 p-6 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">Affordable laptops perfect for students in Rawatsar colleges and schools</p>
            ...
            <div className="bg-gradient-to-br from-tertiary-50 to-tertiary-100 dark:from-tertiary-900/20 dark:to-tertiary-800/20 p-6 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">Professional laptops for office work and business in Rawatsar</p>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/20 dark:to-gray-700/20 p-6 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">Mice, keyboards, bags, and other laptop accessories delivered to Rawatsar</p>
        ...
        {/* Service Areas in Rawatsar */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800 dark:text-white">
            We Deliver Across Rawatsar Tehsil
          </h2>
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <h4 className="font-semibold text-gray-800 dark:text-white">Rawatsar City</h4>
                <p className="text-sm text-gray-600 dark:text-gray-300">Free Delivery</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <h4 className="font-semibold text-gray-800 dark:text-white">Rawatsar Villages</h4>
                <p className="text-sm text-gray-600 dark:text-gray-300">Free Delivery</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
        ...
        <div className="bg-gradient-to-r from-primary-600 to-accent-600 text-white rounded-2xl p-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Buy Your Laptop in Rawatsar?</h2>
          <p className="text-xl mb-8 opacity-90">
            Call us now for free consultation and get your laptop delivered to Rawatsar
          </p>
